...
setwd("C:\\Users\\admin\\Documents\\Jigsaw\\Intro to R\\6.12.15")                            
...
data1[1,1] #Indices in R start from 1 not 0

#Subsetting/Slicing multiple rows and columns

data1[,1:5] #Need to assign vector of indices
...
library(jsonlite)
data2<-fromJSON("C:\\Users\\admin\\Documents\\Jigsaw\\Intro to R\\6.12.15\\Visa.txt")
...
save.image(file="C:\\Users\\admin\\Documents\\Jigsaw\\Intro to R\\6.12.15\\Workspace.RData")

rm(data1, model1)

load("C:\\Users\\admin\\Documents\\Jigsaw\\Intro to R\\6.12.15\\Workspace.RData")
...
import1<-read.table("C:\\Users\\admin\\Documents\\Jigsaw\\Intro to R\\6.12.15\\sample2.csv",sep=",",header = TRUE)

summary(import1) #Focus on the missing values
str(import1) #Are column data types correct

import2<-read.table("C:\\Users\\admin\\Documents\\Jigsaw\\Intro to R\\6.12.15\\sample1.txt")#Why error

import2<-read.table("C:\\Users\\admin\\Documents\\Jigsaw\\Intro to R\\6.12.15\\sample1.txt",sep="\t")

import2#What is wrong?

import2<-read.table("C:\\Users\\admin\\Documents\\Jigsaw\\Intro to R\\6.12.15\\sample1.txt",sep="\t",header=TRUE)

summary(import2)
str(import2)

import2<-read.table("C:\\Users\\admin\\Documents\\Jigsaw\\Intro to R\\6.12.15\\sample1.txt",sep="\t",header=TRUE,na.strings = c(NA,"Missing",""))
...
library(XML)
web3<-readHTMLTable("https://www.inflationdata.com/Inflation/Consumer_Price_Index/HistoricalCPI.aspx?reloaded=true")

class(web3)

#One can save the web page locally and still read in the tables

web4<-readHTMLTable("C:\\Users\\suhani\\Downloads\\Intro to R\\6.12.15\\Historical Consumer Price Index (CPI).html")
...
write.csv(web4,"C:\\Users\\suhani\\Downloads\\Intro to R\\6.12.15\\cpi.csv",row.names = F)

web5<-read.csv("C:\\Users\\suhani\\Downloads\\Intro to R\\6.12.15\\cpi.csv")

head(web5)#Need to skip the first line

web5<-read.csv("C:\\Users\\suhani\\Downloads\\Intro to R\\6.12.15\\cpi.csv",skip=1)
head(web5)
