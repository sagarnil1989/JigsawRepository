...
data1 <- read.csv("~/Documents/Jigsaw/Intro to R/6.12.15/cpu.csv")
...
save.image(file="~/Documents/Jigsaw/Intro to R/6.12.15/Workspace.RData")

rm(data1,model1,a,b,e)

load("~/Documents/Jigsaw/Intro to R/6.12.15/Workspace.RData")
...
import1<-read.table("~/Documents/Jigsaw/Intro to R/6.12.15/sample2.csv",sep=",",header = TRUE)

summary(import1) #Focus on the missing values
str(import1) #Are column data types correct

import2<-read.table("~/Documents/Jigsaw/Intro to R/6.12.15/sample1.txt")#Why error

import2<-read.table("~/Documents/Jigsaw/Intro to R/6.12.15/sample1.txt",sep="\t")

import2#What is wrong?

import2<-read.table("~/Documents/Jigsaw/Intro to R/6.12.15/sample1.txt",sep="\t",header=TRUE)

summary(import2)
str(import2)

import2<-read.table("~/Documents/Jigsaw/Intro to R/6.12.15/sample1.txt",sep="\t",header=TRUE,na.strings = c(NA,"Missing",""))
